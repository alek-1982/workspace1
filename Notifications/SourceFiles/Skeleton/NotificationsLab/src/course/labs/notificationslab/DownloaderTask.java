		...
		mApplicationContext.sendOrderedBroadcast(
				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (/*change this*/ -1 != getResultCode()) {
							...
							NotificationManager mNotificationManager = (NotificationManager) mApplicationContext.getSystemService(mApplicationContext.NOTIFICATION_SERVICE);
