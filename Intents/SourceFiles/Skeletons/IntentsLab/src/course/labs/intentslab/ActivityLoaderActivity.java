...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent exIntent = new Intent(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
	...
	//	int numberAct = activities.size();
		...
		chooserIntent = Intent.createChooser(webIntent, "choose browser");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		final TextView resultTextView =  (TextView) findViewById(R.id.textView1);
		if (RESULT_OK == resultCode && requestCode == 1){
			resultTextView.setText(data.getExtras().getString("1"));
			}
